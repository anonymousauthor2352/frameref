"""
Example usage:
    python ./frameref/evaluation/diagnostic_model_evaluate.py  \
    ...
    --dataset_name 20260115T095923-diagnostic-test
"""
...
# ---------------- Args ----------------
BATCH_SIZE = 16 # 64 - smaller models # 16 - llama 70b
...
# Results
OUTPUT_DIR = os.path.join(PROJ_STORE_PATH, "experiments", "model-evaluate-diagnostic", MODEL_CHOICE)
...
LOGS_DIR = os.path.join(PROJ_STORE_PATH, "logs", "experiments", "model-evaluate-diagnostic", MODEL_CHOICE)
